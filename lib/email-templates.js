...
//   - renderClientEmail -> accuse de reception envoyé au visiteur
...
// ============================================================
// 1) Email envoyé a NISSI (admin) quand un visiteur envoie le form
// ============================================================
          ...
          <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="width:600px;max-width:100%;background:#ffffff;border-radius:18px;box-shadow:0 30px 60px -30px rgba(196,18,48,.18);overflow:hidden;border:1px solid ${BRAND.line}">
            ...
            <tr>
              <td style="padding:42px 42px 8px;">
                ...
                ${renderSubtitle('Un visiteur vient d\'envoyér un message depuis le site. Voici tous les détails pour y répondre rapidement.')}
                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse">
                  ...
                  ${renderField('Téléphone', d.Téléphone, true)}
                  ...
                  <tr>
                    <td align="center">
                      ...
                      <p style="margin:18px 0 0">
                        <a href="tel:${esc(d.Téléphone || '')}" style="font:600 13px 'Manrope',Helvetica,Arial,sans-serif;color:${BRAND.red};text-decoration:none">Ou appeler ${esc(d.Téléphone || 'le contact')}</a>
                      </p>
                    </td>
                  </tr>
                </table>
...
export function renderClientEmail(d, opts){
          ...
          <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="width:600px;max-width:100%;background:#ffffff;border-radius:18px;box-shadow:0 30px 60px -30px rgba(196,18,48,.18);overflow:hidden;border:1px solid ${BRAND.line}">
            ...
            <tr>
              <td style="padding:46px 42px 16px;">
                ...
                ${renderSubtitle('Nous avons bien reçu votre message. Notre équipe le traite dans les plus brefs délais - vous recevrez une réponse personnalisée sous 24 heures ouvrées.')}
  ...
  return wrap('Nous avons bien reçu votre message - NISSI Assurances', content);
}
